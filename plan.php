				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								<label class="control-label">Upper Limit</label>
								<div class="input-group">
								  <input type="number" step="any" min="0" max="100000000" class="form-control text-right" name="days" aria-label="Interest">
							...
							<div class="form-group">
								<label class="control-label">Upper Limit</label>
								<div class="input-group">
								  <input type="number" step="any" min="0" max="100000000" class="form-control text-right" name="interest_percentage" aria-label="Interest">
								  <div class="input-group-append">
								    <span class="input-group-text">ksh</span>
								  </div>
								</div>
						...
						<table class="table table-bordered">
							...
							<tbody style="background-color: white !important;">
								...
								<tr>
									...
									<td class="">
										 <p><small>Lower Limit: <b><?php echo $row['days']. " ksh" ?></b></small></p>
										 <p><small>Upper Limit: <b><?php echo $row['interest_percentage']."ksh" ?></b></small></p>
										 <p><small>Interest: <b><?php echo $row['penalty_rate']."%" ?></b></small></p>
									</td>
